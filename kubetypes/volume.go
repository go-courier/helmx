...
type KubeVolumeSource struct {
	EmptyMediumDir        map[string]string                  `toml:"emptyMediumDir,omitempty" json:"emptyMediumDir,omitempty" yaml:"emptyMediumDir,omitempty"`
	EmptyDir              interface{}                        `toml:"emptyDir,omitempty" json:"emptyDir,omitempty" yaml:"emptyDir,omitempty"`
